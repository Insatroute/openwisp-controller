    ...
    window.createChart = function (data, x, id, title, type, quickLink) {
        ...
        var mode = x.length > 30 ? 'lines' : 'markers+lines',
            layout = {
                ...
                x: 1,                   // position legend at right edge of plot
                xanchor: 'left',        // anchor legend box by its left side
                y: 1,                   // align legend with top of plot
                yanchor: 'top',         // anchor legend box by its top
                traceorder: 'normal'
                },
                xaxis: xaxis,
                yaxis: yaxis,
